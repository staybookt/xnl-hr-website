...
export default function MediationPage() {
  return (
    <>
      {/* HERO — cooler/calmer mesh for mediation */}
      <section
          ...
          <Container size="wide">
            <motion.div initial="hidden" animate="show" variants={STAGGER} className="max-w-5xl">
              ...
              >
                ...
                <span className="text-brand-gradient">Keep the people.</span>
              </motion.h1>
              ...
              <motion.div
                variants={FADE_UP}
                className="mt-12 md:mt-16 inline-flex items-center gap-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 px-6 py-4"
              >
                <span className="text-[10px] uppercase tracking-[0.18em] font-semibold text-[var(--color-brand)]">
                  Guarantee
                </span>
                <span className="text-[14px] md:text-[15px] font-semibold text-white">
                  Mediation-ready in 10 business days from intake.
                </span>
              </motion.div>
            </motion.div>
          </Container>
        ...
        <Container size="wide">
          ...
          >
            <div className="lg:col-span-4">
              <p className="eyebrow mb-8">The mediator</p>
              ...
              <p className="text-[13px] uppercase tracking-[0.12em] font-semibold text-[var(--color-secondary-deep)] mt-4">
                Independent workplace mediator
              </p>
              <span
                className="inline-flex items-center text-[10px] uppercase tracking-[0.14em] font-semibold text-[var(--color-brand-deep)] bg-[var(--color-brand-soft)] px-2.5 py-1 rounded-full mt-6"
                title="Full bio pending — see PLACEHOLDERS.md"
              >
                Bio pending
              </span>
            </div>
            <div className="lg:col-span-8 space-y-5 text-[17px] md:text-[18px] leading-[1.65] text-[var(--color-ink-soft)]">
              <p>
      ...
      <section className="py-24 md:py-32 lg:py-40 bg-[var(--color-paper)]">
        <Container size="wide">
          ...
          >
            ...
            <h2 className="text-[length:var(--text-display-xl)] leading-[var(--text-display-xl--line-height)] tracking-[var(--text-display-xl--letter-spacing)] font-semibold text-[var(--color-ink)]">
              From intake to written record.<br />
              <span className="text-[var(--color-brand-deep)]">In ten business days.</span>
            </h2>
          </motion.div>
        ...
        <Container size="wide">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
            <div className="md:col-span-4">
              ...
              <h3 className="text-[28px] md:text-[32px] leading-[1.15] tracking-[-0.02em] font-semibold text-[var(--color-ink)]">
                Per-session pricing.
              </h3>
            </div>
            <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="rounded-2xl bg-[var(--color-paper)] border border-[var(--color-rule)] p-6">
                ...
                <p className="text-[12px] text-[var(--color-mute)] inline-flex items-center gap-1.5">
                  Per session
                  <span className="text-[9px] uppercase tracking-[0.14em] font-semibold text-[var(--color-brand-deep)] bg-[var(--color-brand-soft)] px-2 py-0.5 rounded-full">Illustrative</span>
                </p>
              </div>
              <div className="rounded-2xl bg-[var(--color-paper)] border border-[var(--color-rule)] p-6">
