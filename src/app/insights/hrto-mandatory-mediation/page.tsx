...
export default function HRTOArticle() {
  return (
    <>
      ...
      <section className="bg-[var(--color-paper)] pt-24 md:pt-32 pb-10 md:pb-16">
        <Container size="narrow">
          <Link href="/insights" className="inline-flex items-center gap-2 text-[13px] uppercase tracking-[0.14em] font-semibold text-[var(--color-secondary-deep)] hover:text-[var(--color-brand)] transition-colors mb-10">
            <span aria-hidden="true">←</span> All insights
          </Link>
          {/* Mobile-safe chip row: wraps cleanly, hides middle separators on tight viewports */}
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2 mb-6">
            ...
            <span className="hidden sm:inline text-[var(--color-rule-strong)]" aria-hidden="true">·</span>
            ...
            <span className="text-[9px] uppercase tracking-[0.14em] font-semibold text-white bg-[var(--color-brand)] px-2 py-0.5 rounded-full sm:ml-2">Original</span>
          </div>
      ...
      <section className="pb-20 md:pb-28 bg-[var(--color-paper)]">
        <Container size="narrow">
          <article>
            <p className="text-[16px] md:text-[19px] leading-[1.7] md:leading-[1.75] text-[var(--color-ink-soft)] mb-7">
            ...
            <p className="text-[16px] md:text-[19px] leading-[1.7] md:leading-[1.75] text-[var(--color-ink-soft)] mb-12">
            ...
            <h2 className="text-[24px] md:text-[34px] leading-[1.2] tracking-[-0.022em] font-semibold text-[var(--color-ink)] mt-12 mb-5">
              1. &ldquo;Mediation is where the case stalls.&rdquo;
            </h2>
            <p className="text-[16px] md:text-[19px] leading-[1.7] md:leading-[1.75] text-[var(--color-ink-soft)] mb-6">
            ...
            <blockquote className="text-[22px] md:text-[28px] leading-[1.35] tracking-[-0.022em] font-medium text-[var(--color-ink)] border-l-2 border-[var(--color-brand)] pl-5 md:pl-8 my-12 md:my-16 italic">
      ...
      {/* MORE FROM EVERT */}
      <section className="bg-[var(--color-surface)] border-y border-[var(--color-rule)] py-16 md:py-28">
        <Container size="narrow">
          <div className="flex flex-wrap items-baseline justify-between gap-3 mb-10 border-b border-[var(--color-rule)] pb-5">
              ...
              .map((a) => (
                <article key={a.slug} className="group">
                  <Link href={a.url} className="block">
                    ...
                    <h3 className="text-[20px] md:text-[26px] leading-[1.2] tracking-[-0.018em] font-semibold text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-slate)] transition-colors">
                      {a.title}
                    </h3>
