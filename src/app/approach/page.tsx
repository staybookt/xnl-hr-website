        ...
        <Container size="narrow">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-[17px] md:text-[18px] leading-[1.75] text-[var(--color-ink-soft)] mb-3">
                Most HR matters have more documentation than the employer remembers, and less than the employer needs. Before we add to the record, we read what&rsquo;s already in it — the prior performance review, the email from October, the handbook section that nobody&rsquo;s opened in three years.
              </p>
              <p className="text-[17px] md:text-[18px] leading-[1.75] text-[var(--color-ink-soft)]">
            ...
            <div>
              ...
              <p className="text-[17px] md:text-[18px] leading-[1.75] text-[var(--color-ink-soft)] mb-3">
                Every output we produce is built to survive scrutiny — by an auditor, a tribunal, or a court. That means plain language, specific facts, dated documentation, and language that the people on either side of the file can actually live with.
              </p>
              <p className="text-[17px] md:text-[18px] leading-[1.75] text-[var(--color-ink-soft)]">
